<template>
    <div class="flex_center" style="padding: 0px;" >
        <!--<div class="top_s1">-->
            ...
            <!--</a>-->
        <!--</div>-->
        <div class="flex_center" style="width: 260px;height: 195px;padding: 0px;display: inline-block;">
            ...
            <img v-if="option.img == null" src="../images/head_edit.png" />
        </div>
