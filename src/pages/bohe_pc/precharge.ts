...
class Recharge extends RechargeProxy {
    ...
    public paySuccess() {
        ...
        this.payDialogVisible = false;
        this.$alert(TipsMsgUtil.getTipsMsg(TipsMsgUtil.KEY_NOTIF_PAY_PACKAGE_SUCCESS),TipsMsgUtil.getTipsMsg(TipsMsgUtil.KEY_NOTIF_SUCCESS_TITLE), {
            confirmButtonText: self.$i18n.t('user.z13').toString(),
            callback: action => {
