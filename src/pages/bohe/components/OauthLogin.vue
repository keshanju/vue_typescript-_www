    ...
    <div>
        ...
        <ul class="third_login">
            <li class="third_login_type">
                <a :href="'https://open.weixin.qq.com/connect/qrconnect?appid=wxa2f4d7b57bb97e5a&redirect_uri=https://api.bohe.com/api/auth/open/wx&response_type=code&scope=snsapi_login&state='+webParam.region_code+'_0_'+languageType+'&connect_redirect=1#wechat_redirect'">
                    <i class="third_login_wechat third_login_icon"></i>
                </a>
            </li>
            <li class="third_login_type">
                <a :href="'https://graph.qq.com/oauth2.0/show?which=Login&display=pc&response_type=code&client_id=101502267&redirect_uri=https://api.bohe.com/api/auth/open/qq&state='+webParam.region_code+'_0_'+languageType+'&scope=get_user_info'">
                    <i class="third_login_qq third_login_icon"></i>
                </a>
            </li>
            <li class="third_login_type">
                <a :href="'https://api.weibo.com/oauth2/authorize?client_id=1072947333&response_type=code&state='+webParam.region_code+'_0_'+languageType+'&redirect_uri=https://api.bohe.com/api/auth/open/sina'">
