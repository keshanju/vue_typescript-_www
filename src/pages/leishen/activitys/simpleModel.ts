...
import './assets/less/simpleModel.less';
...
//判断是否跳转移动站点
const mUrl = GlobalConfig.getMobWebBaseUrl() + '/' + 'zhishu.html';
...
class activityModel extends ActivityProxy {
     ...
     */
    public gotoLogin() {
        JumpWebUtil.webGotoUser(GlobalConfig.getUserBaseUrl(), JumpWebUtil.HTML_NAME_LOGIN,'to=https://www.leigod.com/zhishu&page=1');
    }
